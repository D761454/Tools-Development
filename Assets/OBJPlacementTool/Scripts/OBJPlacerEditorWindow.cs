...
public class OBJPlacerEditorWindow : EditorWindow
{
    ...
    {
        serializedClass = AssetDatabase.LoadAssetAtPath<OBJPlacerScriptableOBJ>("Assets/OBJPlacementTool/Scripts/OBJ Placer Scriptable OBJ.asset");

        if (!serializedClass)
        {
            serializedClass = CreateInstance<OBJPlacerScriptableOBJ>();
            AssetDatabase.CreateAsset(serializedClass, "Assets/OBJPlacementTool/Scripts/OBJ Placer Scriptable OBJ.asset");
    ...
    public void CreateGUI()
    {
        ...
        visualTree = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>("Assets/OBJPlacementTool/UXML/OBJPlacementMainEditor.uxml");
        visualTree.CloneTree(root);

        StyleSheet sheet = AssetDatabase.LoadAssetAtPath<StyleSheet>("Assets/OBJPlacementTool/USS/OBJPlacementMainEditor.uss");
        root.styleSheets.Add(sheet);

        groupTree = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>("Assets/OBJPlacementTool/UXML/GroupUI.uxml");
        groupItemTree = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>("Assets/OBJPlacementTool/UXML/GroupItemUI.uxml");
